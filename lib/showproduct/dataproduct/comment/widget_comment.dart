...
Widget comment(
    ...
    int pageReviewCur,
    int maxPageReview,
    void Function(int page) updatePageReview,
    double startAll,
    double rateAll) {
  String typeSc1;
  double allpad;
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                        ...
                        children: [
                          Row(children: [
                            Text("${startAll.round()}/5",
                                style: const TextStyle(
                                    fontSize: 13, color: Color(0xffed3023))),
                            Text(" (${rateAll.round()} รีวิว)",
                                style: const TextStyle(
      ...
      typeSc1 == "pc"
          ? Container(
              ...
              child: Row(
                ...
                children: [
                  Pagecomment(
                    currentPage: pageReviewCur,
                    totalPages: maxPageReview,
                    onPageChanged: (page) {
