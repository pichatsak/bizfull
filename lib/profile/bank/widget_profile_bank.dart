...
import 'package:bizfull/profile/bank/widget_bank.dart';
...
class ProfileBank extends StatefulWidget {
  const ProfileBank({Key? key}) : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  BootstrapContainer(
                      ...
                      children: [
                        bM == "pc" ? barbank(context) : barbankmobile(context),
                      ]),
                  BootstrapContainer(
                    ...
                    children: [
                      BootstrapRow(children: <BootstrapCol>[
                        BootstrapCol(
                            ...
                            child: leftbank(context)),
                        BootstrapCol(
                            sizes: 'col-lg-10 col-12 col-sm-12 col-md-12',
                            child: Column(
                              children: [bankprofile()],
                            ))
                      ])
                    ],
                  ),
