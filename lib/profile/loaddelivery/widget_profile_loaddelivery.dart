...
import 'package:bizfull/profile/loaddelivery/widget_dararight_load.dart';
import 'package:bizfull/profile/loaddelivery/widget_left_load.dart';
...
class ProfileLoadDelivery extends StatefulWidget {
  const ProfileLoadDelivery({Key? key}) : super(key: key);

  @override
  State<ProfileLoadDelivery> createState() => _ProfileLoadDeliveryState();
}

class _ProfileLoadDeliveryState extends State<ProfileLoadDelivery> {
              ...
              child: Column(
                children: [
                  ...
                  BootstrapContainer(
                      ...
                      children: [
                        bM == "pc" ? barload(context) : barloadmobile(context),
                      ]),
                  BootstrapContainer(
                    ...
                    children: [
                      BootstrapRow(children: <BootstrapCol>[
                        BootstrapCol(
                            ...
                            child: leftload(context)),
                        BootstrapCol(
                            sizes: 'col-lg-10 col-12 col-sm-12 col-md-12',
                            child: Column(
                              children: [
                                datarightload(context, key, setState,
