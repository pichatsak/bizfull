...
import 'package:bizfull/homepage/shopping/widget_show_product_shipping2.dart';
import 'package:flutter/material.dart';
import 'package:responsive_sizer/responsive_sizer.dart';

Widget showproductshopping1(BuildContext context) {
                      ...
                      child: ListView(
                        ...
                        children: <Widget>[
                          ...List.generate(10, (index) {
                            return SizedBox(
                                width: c,
                                child: product22shopping1(d, hM, hM1, fM,index));
                          })
                        ],
                      ),
                    ),
