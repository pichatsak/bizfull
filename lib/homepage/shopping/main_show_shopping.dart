...
import 'package:bizfull/homepage/shopping/widget_show_product_shipping1.dart';
import 'package:flutter/material.dart';
import 'package:responsive_sizer/responsive_sizer.dart';

Widget showproductshopping(BuildContext context) {
                        ...
                        children: <Widget>[
                          ...List.generate(10, (index) {
                            return SizedBox(
                                width: c,
                                child:
                                    product22shopping(d, hM, hM1, fM, index));
                          })
                        ],
                      ),
                    ),
